 ...
 * @returns {Array.<object>} An array of objects representing the links parsed
 * from the specified input string.
 * @throws {Error} If the quoted parameter value cannot be converted by the
 * specified `quotedValueConverter`.
 */
function parse(input, options)
{
  ...
  if (matchedLinks)
  {
    ...
    {
      linkValueList.push(parseLink(matchedLinks[i], options));
    }
  }
